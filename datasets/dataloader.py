...
class LFW(data.Dataset):
    def __init__(self, root, file_list, transform=None, loader=img_loader):
        ...
        for i, p in enumerate(pairs):
            ...
            if os.path.isfile(os.path.join(root, nameL)) and os.path.isfile(os.path.join(root, nameR)):
...
if __name__ == '__main__':
    ...
    trainloader = data.DataLoader(dataset, batch_size=32, shuffle=False, num_workers=2, drop_last=False)
